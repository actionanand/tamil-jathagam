...
```bash
git clone https://github.com/actionanand/tamil-jathagam.git --branch 1-skeleton angular-proj-name
```

```bash
npx degit github:actionanand/tamil-jathagam#1-skeleton angular-proj-name
```
